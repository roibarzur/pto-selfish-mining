...
class LDDQNAlgorithm(RLAlgorithm):
    ...
    def create_agent(self) -> LDDQNAgent:
        ...
        use_confidence = self.creation_args.get('use_confidence', False)
        return LDDQNAgent(self.create_approximator(), self.simulator, starting_epsilon=starting_epsilon,
                          ...
                          value_clip=value_clip, nn_factor=nn_factor, use_confidence=use_confidence)
    ...
    def create_loss_fn(self) -> HuberLossFunction:
        ...
        return HuberLossFunction(self.approximator, self.simulator,
                                 ...
                                 beta=huber_beta, normalize_target_values=normalize_target_values,
